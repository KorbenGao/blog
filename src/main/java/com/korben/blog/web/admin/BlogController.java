...
import com.korben.blog.service.TypeService;
...
public class BlogController {
    ...
    public String post(Blog blog, RedirectAttributes attributes, HttpSession session) {
        ...
        if (b == null) {
            attributes.addFlashAttribute("message", "create new blog failed");
        } else {
            attributes.addFlashAttribute("message", "create new blog succeed");
        }
